...
public class CriarTipoAcomodacaoView extends JFrame {
	...
	AcomodacaoController tipoAcomodacaoController = new AcomodacaoController();
	...
	public void adicionarTipoAcomodacao() {
		tipoAcomodacaoController.adicionarTipoAcomodacao(textField.getText(),textField_1.getText(),textField_2.getText());
		limparCampos();
	}
